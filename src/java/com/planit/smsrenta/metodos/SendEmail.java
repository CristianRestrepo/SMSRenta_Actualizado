...
public class SendEmail {
    ...
    public void sendEmailHtmlPrueba() {
        ...
        try {
            ...
            String messageHtml = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n"
                    ...
                    + "<table>\n"
                    + "<tr>\n"
                    + "<th> <img src=\"http://smsrenta.com/images/ai/logo.png\"> </th>\n"
                    + "</tr>\n"
                    + "</table>\n"
                    + "</th>\n"
                    ...
                    + "<tr>\n"
                    + "<th>\n"
                    + "<p class=\"text-right\"><a href=\"http://smsrenta.com\" style=\" color: #FC5B35;\">Página Web SMS Renta</a></p>\n"
                    + "</th>\n"
                    + "</tr>\n"
                    + "</table>\n"
                    + "</th>\n"
                    ...
                    + "<tr>\n"
                    + "<th>\n"
                    + "<h1>Hola, Susan Calvin</h1>\n"
                    + "\n"
                    + "<p class=\"content-txt\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut optio nulla et, fugiat. Maiores accusantium nostrum asperiores provident, quam modi ex inventore dolores id aspernatur architecto odio minima perferendis, explicabo.\n"
                    ...
                    + "		<td>\n"
                    + "			<center data-parsed=\"\">\n"
                    + "				<a href=\"http://zurb.com\" align=\"center\" class=\"float-center\">Twitter</a>\n"
                    + "			</center>\n"
                    + "		</td>\n"
                    + "	</tr>\n"
                    + "</table>-->\n"
                    ...
                    + "<tr>\n"
                    + "<td>\n"
                    + "<center data-parsed=\"\"><a href=\"http://zurb.com\" align=\"center\" class=\"float-center\">Facebook</a></center>\n"
                    + "</td>\n"
                    + "</tr>\n"
                    + "</table>\n"
                    + "</td>\n"
