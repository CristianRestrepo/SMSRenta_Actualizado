...
public class SendEmail {
    ...
    public void sendEmailCliente(SmsEmpleado empleado, SmsVehiculo vehiculo, SmsReservacion reservacion, SmsUsuario Cliente) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola, " + cliente.getUsuarioNombre() + "</h1>"
                    + "\n"
    ...
    public void sendEmailAdministrador(SmsEmpleado empleado, SmsVehiculo vehiculo, SmsReservacion reservacion, SmsUsuario Cliente) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola, Administrador Principal</h1>"
                    + "\n"
    ...
    public void sendEmailConductor(SmsEmpleado empleado, SmsVehiculo vehiculo, SmsReservacion reservacion, SmsUsuario Cliente) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola " + empleado.getSmsUsuario().getUsuarioNombre() + "<h1>"
                    + "\n"
    ...
    public void sendEmailAdministradorBienvenida(SmsUsuario Admin, String password) {
        ...
        try {
            ...
            message.setSubject("Bienvenido a SMS Renta");
            String mensajehtml = style + inicio + "<h1>Hola, " + Admin.getUsuarioNombre() + "</h1>"
                    + "\n"
                    + "<p class=\"content-txt\">Le confirmamos que su registro al sistema SMS Renta fue exitoso, y le damos la bienvenida a nuestra familia. \n"
                    + "Los datos de sesion para acceder al sistema son:.\n"
    ...
    public void sendEmailProveedor(SmsUsuario usuario, SmsProveedor proveedor, String password) {
        ...
        try {
            ...
            message.setSubject("Bienvenido a SMS Renta");
            String mensajehtml = style + inicio + "<h1>Señores " + proveedor.getProveedorRazonSocial() + "</h1>"
                    + "\n"
                    + "<p class=\"content-txt\">Le confirmamos que su registro al sistema SMS Renta fue exitoso, y le damos la bienvenida a nuestra familia. \n"
    ...
    public void sendEmailConductor(SmsUsuario conductor, String password) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola, " + conductor.getUsuarioNombre() + "</h1>"
                    + "\n"
                    + "<p class=\"content-txt\">Le confirmamos que su registro al sistema SMS Renta fue exitoso, y le damos la bienvenida a nuestra familia. \n"
    ...
    public void sendEmailNuevaContrasena(SmsUsuario usuario, String password) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola, " + usuario.getUsuarioNombre() + "</h1>"
                    + "\n"
    ...
    public void sendEmailMalaCalificacion(SmsCalificacion calificacion) {
        ...
        try {
            ...
            String mensajehtml = style + inicio + "<h1>Hola, el cliente " + calificacion.getSmsReservacion().getSmsUsuario().getUsuarioNombre() + "</h1>\n"
